...
// A:
let age = today - born;
let answer = "Tim is " + age + " years old";

// 8.
// Adjust this code. Store some information in the following variables.
// A:
let yourName = "Diana";
let instructorName = "Jimmy Jacobson";


// 9.
// Update the variables `yourName` and `instructorName` so the expression below reads correctly.
// A:let yourName = "Diana";
//   let instructorName = "Jimmy Jacobson";
...
let myUndefined;
// A: do not set a value on myUndefined so it's stays undefined.
...
// A: False! ---Note changed the varible name
...
let thisIsAnotherX = 1 * undefined;
...
// A: False! --Changed variable name because x was already declared.
